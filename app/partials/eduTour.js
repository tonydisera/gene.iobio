class EduTour {
  constructor() {
    this.pageGuide = null;
    this.pageGuideBookmarks = null;
    this.pageGuidePhenolyzer = null;
    this.pageGuideEduTour1 = null;
    this.pageGuideEduTour2 = null;
    ...
    if (!isLevelEdu) {
      ...
      me.pageGuide = tl.pg.init({
        ...
        'handle_doc_switch': function(currentTour, prevTour) {
          ...
          if (step) {
            me.customizeStep(pageGuide, step);
          } else {
  ...
  customizeTourStep(pageGuide, step) {
    let me = this;
