function MatrixCard() {
	...
	this.clinvarMap     = {
                        ...
                        'drug_response'         : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'confers_sensitivity'   : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'risk_factor'           : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'other'                 : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'association'           : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'protective'            : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'not_provided'          : {value: 131, badge: true, examineBadge: true, clazz: 'clinvar_other', symbolFunction: this.showClinVarSymbol},
                        'likely_benign'         : {value: 141, badge: true, examineBadge: true, clazz: 'clinvar_lbenign', symbolFunction: this.showClinVarSymbol},
                        'benign/likely_benign'  : {value: 141, badge: true, examineBadge: true, clazz: 'clinvar_lbenign', symbolFunction: this.showClinVarSymbol},
                        'benign'                : {value: 151, badge: true, examineBadge: true, clazz: 'clinvar_benign', symbolFunction: this.showClinVarSymbol},
