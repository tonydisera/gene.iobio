function variantD3() {
  ...
  var clazz = function (d) { 
    ...
    return  'variant ' + d.type.toLowerCase() + ' ' + d.zygosity.toLowerCase() + ' ' + d.inheritance.toLowerCase() + ' ' + d.afexaclevel+ ' ' + d.af1000glevel + ' ' + ' ' + impacts + effects + ' ' + d.consensus + colorimpacts ;
  };
