...
function showCaseStudy(tourNumber) {
	var url = (isOffline ? "/?tour=" : "../gene.iobio?tour=") + tourNumber;
	window.location.href = url;
}
function showNewCaseStudy() {
	var url = (isOffline ? "/?tour=" : "../gene.iobio?tour=") + getUrlParameter("tour") + '&completedTour=' + getUrlParameter("completedTour");
	window.location.href = url;
}
