describe('app', function() {
  ...
  describe('#getCodingRegions', function() {
    it('returns an array of coding regions when the transcript_id is not cached', function() {
      ...
      geneModel.transcriptCodingRegions = {};
      var variants = [
      ...
      expect(geneModel.getCodingRegions(transcript)).toEqual(codingRegions);
    });

    it('returns an array of coding regions from the cache', function() {
      geneModel.transcriptCodingRegions = { 123: [{ start: 1, end: 2 }] }
      var transcript = { transcript_id: 123, features: [] };
      expect(geneModel.getCodingRegions(transcript)).toEqual([{ start: 1, end: 2 }]);
    });
    ...
    it('caches the array of coding regions according to transcript_id', function() {
      ...
      geneModel.getCodingRegions(transcript);
      expect(geneModel.transcriptCodingRegions).toEqual({ 123: [{ start: 1, end: 2 }] });
    });
  });
